...
public class HeapTest {
    ...
    @AfterEach
    public void deleteEmptySubDirectoriesOfFolder() {
...
//        return ((URI)store.getHeap().remove());
//    }
    ...
    public void setMaxToZeroToPreventAnyAddition() throws IOException {
        ...
        assert Files.exists(Path.of(System.getProperty("user.dir") + "/edu.yu.cs/com1320/project/doc2.json"));
        store.setMaxDocumentBytes(1000);
        Document doc = store.getDocument(this.uri2);
        assertEquals(this.uri2, doc.getKey());
        assertFalse(Files.exists(Path.of(System.getProperty("user.dir") + "/edu.yu.cs/com1320/project/doc2.json")));
        try{
            store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.BINARY);
        } catch (IllegalArgumentException e){
   ...
   */
    ...
    public void putMakesRoomIfSameURIEvenIfOverLimitBytesVersion() throws IOException {
        ...
        for(URI uri : set){
            assert Files.exists(Path.of(System.getProperty("user.dir") + uri.toString().substring(6) + ".json"));
        }
        assertFalse(Files.exists(Path.of(System.getProperty("user.dir") + "/edu.yu.cs/com1320/project/doc9.json")));
        set.add(this.uri9);
        store.setMaxDocumentBytes(10000);
        for(URI uri : set){
            assertEquals(uri, store.getDocument(uri).getKey());
            assertFalse(Files.exists(Path.of(System.getProperty("user.dir") + uri.toString().substring(6) + ".json")));
        }
        store.putDocument(new ByteArrayInputStream(this.txt6.getBytes()),this.uri6, DocumentStore.DocumentFormat.TXT);
    ...
    public void putReplacesDocWhenLimitIsReachedBytesVersion() throws IOException {
        ...
        set.remove(this.uri9);
        for(URI uri : set){
            assertTrue(Files.exists(Path.of(System.getProperty("user.dir") + uri.toString().substring(6) + ".json")));
        }
        assertFalse(Files.exists(Path.of(System.getProperty("user.dir") + this.uri9.toString().substring(6) + ".json")));
        store.putDocument(new ByteArrayInputStream(this.txt6.getBytes()),this.uri6, DocumentStore.DocumentFormat.TXT);
        assertTrue(Files.exists(Path.of(System.getProperty("user.dir") + this.uri9.toString().substring(6) + ".json")));
        assertFalse(Files.exists(Path.of(System.getProperty("user.dir") + this.uri6.toString().substring(6) + ".json")));
    }
    ...
    public void putReplacesDocWhenLimitIsReached() throws IOException {
        ...
        store.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
        assertFalse(Files.exists(Path.of(System.getProperty("user.dir") + this.uri9.toString().substring(6) + ".json")));
        assertFalse(Files.exists(Path.of(System.getProperty("user.dir") + this.uri2.toString().substring(6) + ".json")));
    }
    ...
    public void docIsRemovedFromCommandSetAndNoOthers() throws IOException {
        ...
        assertTrue(Files.exists(Path.of(System.getProperty("user.dir") + this.uri1.toString().substring(6) + ".json")));
        assertEquals(this.uri1, store.getDocument(this.uri1).getKey());
        store.undo(this.uri3);
        assertTrue(Files.exists(Path.of(System.getProperty("user.dir") + this.uri2.toString().substring(6) + ".json")));
    ...
    public void makeRoomForDocWithTheSameURI() throws IOException {
        ...
        assertEquals(this.uri2, (store.getHeap().remove()));
    }
    ...
    public void makeRoomForBigDoc() throws IOException {
        ...
        HashSet<URI> setWithout0 = new HashSet<>();
        setWithout0.add(this.uri1);
        setWithout0.add(this.uri2);
        setWithout0.add(this.uri3);
        setWithout0.add(this.uri4);
        setWithout0.add(this.uri5);
        setWithout0.add(this.uri6);
        for(URI uri : setWithout0){
            assertTrue(Files.exists(Path.of(System.getProperty("user.dir") + uri.toString().substring(6) + ".json")));
        }
        assertEquals(this.uri0, (store.getHeap().remove()));
    }
    ...
    public void clearMemoryThroughReducingMaxDocCount() throws IOException {
        ...
        DocumentStoreImpl store = this.getStoreWithTextAdded();
        store.setMaxDocumentCount(6);
        assertEquals(this.uri4, (store.getHeap().remove()));
    }
