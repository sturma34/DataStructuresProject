...
public class HashTableImplTest {
    ...
    public void initTable(){
        ...
        this.table.put("Key13", "Value13");
        this.table.put("Key14","Value14");
        this.table.put("Key15","Value15");
        this.table.put("Key16","Value16");
        this.table.put("Key17","Value17");
    }
    ...
    public void testGet() {
        ...
        assertEquals("Value7",this.table.get("Key7"));
        assertEquals("Value8",this.table.get("Key8"));
        assertEquals("Value9",this.table.get("Key9"));
        assertEquals("Value10",this.table.get("Key10"));
        assertEquals("Value11",this.table.get("Key11"));
        assertEquals("Value12",this.table.get("Key12"));
        assertEquals("Value13",this.table.get("Key13"));
        assertEquals("Value14",this.table.get("Key14"));
        assertEquals("Value15",this.table.get("Key15"));
        assertEquals("Value16",this.table.get("Key16"));
    }
    @Test
    public void testGetChained() {
        //second node in chain
        assertEquals("Value17",this.table.get("Key17"));
        //second node in chain after being modified
        this.table.put("Key17","Value17+1");
        assertEquals("Value17+1",this.table.get("Key17"));
    ...
    public void testPutReturnValue() {
        ...
        assertEquals(null,this.table.put("Key18","Value18"));
    }
    @Test
